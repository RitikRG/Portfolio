...
export const personalInfo = {
  ...
  subtitle:
    "Building production systems at the intersection of great UX and real AI. 3 internships. 1 agent live in the wild.",
...
export const featuredProject = {
  ...
  title: "WhatsApp AI\nOrdering Agent",
  subtitle:
    "Voice in, order placed. A 5-layer autonomous ordering system integrated into a full ERP.",
  ...
  featStats: [
    {
      label: "TOOLS",
      value: "12",
      desc: "Custom LLM tools in autonomous loop",
    },
    {
      label: "ARCHITECTURE",
      value: "Multi-tenant",
      desc: "Isolated inventory and SOPs per shop",
    },
    {
      label: "RAG PIPELINE",
      value: "Runtime",
      desc: "Shop SOPs injected into prompt at runtime",
    },
  ],
};
...
export const experiences = [
  ...
  },
  {
    ...
    bullets: [
      [
        "Converted single-org ledger into a multi-tenant SaaS platform - ",
  ...
  },
  {
    ...
    bullets: [
      [
        "Redesigned UI with Laravel Blade + Tailwind - ",
        "35% higher engagement",
        ", ",
        "50%+ more returning users",
      ],
      ["Achieved ", "60% improvement", " in page load performance"],
      [
        "Built a custom VPS-based promotional mail system handling ",
        "90,000+ emails/month",
      ],
    ],
  },
...
export const projects = [
  {
    ...
    tags: [
      ...
      "Node.js",
      "MongoDB",
      { label: "OpenRouter", ai: true },
      { label: "Twilio", ai: true },
      { label: "Whisper", ai: true },
    ],
    links: [
  ...
  },
  {
    ...
    links: [{ label: "Live ->", url: "https://jobsfiy.com/" }],
  },
  {
    ...
    links: [{ label: "Live ->", url: "https://rvibeshomoeopathy.com/" }],
  },
  {
    ...
    links: [{ label: "GitHub ->", url: "https://github.com/RitikRG" }],
  },
  {
